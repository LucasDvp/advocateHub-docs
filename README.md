...
Try the demo (*[end user view](http://advocatehub.westus.cloudapp.azure.com) & [admin dashboard](http://advocatehub.westus.cloudapp.azure.com/admin)*)
...
- ##### Talk‘s detail
  ...
  ​	By scanning the **talk's qrcode** which provided by advocates(or just click from homepage),  users can see the detail of the meeting

  - **General Infos**: users can see this talks general information including location, description, tags, etc. and also the **tweet** information.
...
- ##### Advocate Info  
  ...
  ​	By clicking *from homepage* or talk's detail page, user can see detail information about the advocate

  - **Bio**: user can see this advocate's 

    <img src="https://github.com/LucasDvp/advocateHub-docs/blob/master/imgs/advocatedetail1.png" width="375px">

  - **Homepage**: users can go through advocate's homepage if they config it.
...
- #####  Login by twitter
  ...
  - advocates need to **initialize their account**, fill the basic information(twitter alias, github alias, facebook publicPage etc.) to let users know more about you, they can also link their **Linkedin** account to fill in the bio informations
